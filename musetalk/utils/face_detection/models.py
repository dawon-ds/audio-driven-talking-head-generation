...
class ConvBlock(nn.Module):
    ...
    def forward(self, x):
        residual = x
        out1 = self.bn1(x); out1 = F.relu(out1, True); out1 = self.conv1(out1)
        out2 = self.bn2(out1); out2 = F.relu(out2, True); out2 = self.conv2(out2)
        out3 = self.bn3(out2); out3 = F.relu(out3, True); out3 = self.conv3(out3)
