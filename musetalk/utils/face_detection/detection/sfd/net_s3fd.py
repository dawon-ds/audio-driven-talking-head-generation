...
class s3fd(nn.Module):
    ...
    def forward(self, x):
        h = F.relu(self.conv1_1(x)); h = F.relu(self.conv1_2(h)); h = F.max_pool2d(h, 2, 2)
        h = F.relu(self.conv2_1(h)); h = F.relu(self.conv2_2(h)); h = F.max_pool2d(h, 2, 2)
        h = F.relu(self.conv3_1(h)); h = F.relu(self.conv3_2(h)); h = F.relu(self.conv3_3(h)); f3_3 = h; h = F.max_pool2d(h, 2, 2)
        h = F.relu(self.conv4_1(h)); h = F.relu(self.conv4_2(h)); h = F.relu(self.conv4_3(h)); f4_3 = h; h = F.max_pool2d(h, 2, 2)
        h = F.relu(self.conv5_1(h)); h = F.relu(self.conv5_2(h)); h = F.relu(self.conv5_3(h)); f5_3 = h; h = F.max_pool2d(h, 2, 2)
